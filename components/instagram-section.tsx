        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center items-center py-20">
            <div className="flex flex-col items-center gap-4">
              <Loader2 className="h-8 w-8 animate-spin text-[#E4405F]" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <Button onClick={fetchInstagramPosts} className="bg-[#E4405F] hover:bg-[#C13584] text-white">
                Intentar de nuevo
              </Button>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
                  ...
                  {!isVideo && (
                    <div
                      className={`
                        ...
                        bg-gradient-to-br from-[#E4405F]/90 via-[#C13584]/90 to-[#833AB4]/90
                      `}
                    >
                      {/* Caption del post */}
          ...
          {totalSlides > 1 && (
            <div className="flex justify-center items-center gap-4 mt-6">
              <Button
                variant="outline"
                size="icon"
                className="rounded-full border-[#E4405F] text-[#E4405F] hover:bg-[#E4405F] hover:text-white"
                onClick={prevSlide}
                ...
                {Array.from({ length: totalSlides }).map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${
                      i === currentSlide ? "bg-[#E4405F] w-4" : "bg-gray-300"
                    }`}
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border-2 border-[#E4405F] text-[#E4405F] px-6 py-3 rounded-full font-semibold hover:bg-[#E4405F] hover:text-white transition-all duration-300"
          >
